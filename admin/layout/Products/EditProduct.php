        ...
        <div class="right">
            ...
            <div class="content_basic">
                ...
                <form method ="POST" action="" enctype = "multipart/form-data">
                    ...
                    <input type="text" name="productName" class="col-6" value="<?php  echo $rows_up ['name'];?>" required><br/>
                    <label for="CategoryName">Giá : </label>
                    <span class="error">* <?php echo $priceErr; ?> </span><br/>
                    <input type="text" name="productPrice" class="col-6" value="<?php  echo $rows_up ['price'];?>" required><br/>
                    ...
                    <input type="text" name="productQuantity" class="col-6" value="<?php  echo $rows_up ['quantity'];?>" required><br/>
